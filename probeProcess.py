...
def dot11_probe_resp(destaddr, wtpmac, sc):
    ...
    probe_response_packet = RadioTap(len=18, present='Flags+Rate+Channel+dBm_AntSignal+Antenna',
                            ...
                            / Dot11(subtype=5, addr1=destaddr, addr2=wtpmac, addr3=constants.DEVICE_MAC, SC=sc) \
    ...
    sendp(probe_response_packet, iface=constants.DEVICE_NAME, verbose=False, count=1)