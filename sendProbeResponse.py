...
def dot11_probe_resp():
    ...
    probe_response_packet = RadioTap(len=18, present='Flags+Rate+Channel+dBm_AntSignal+Antenna', notdecoded='\x00\x6c' + struct.pack("<h", 2407) + '\xc0\x00\xc0\x01\x00\x00') \
                            / Dot11(subtype=5, addr1=constants.BEACON_ADDR1, addr2=constants.BEACON_ADDR2, addr3=constants.BEACON_ADDR3,
                                    SC=1000) \
...
## Setup sniff
sniff(iface=device, prn=probe_response)